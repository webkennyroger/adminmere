...
<body class="bg-gray-100 dark:bg-zinc-900">
 ...
 <a href="/"
 class="inline-flex items-center justify-center border border-zinc-300 bg-white px-5 py-3.5 text-sm font-medium text-zinc-700 shadow-md hover:bg-zinc-50 hover:text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:bg-white/[0.03] dark:hover:text-zinc-200">
