            ...
            <div class="p-4 border-t border-zinc-100 dark:border-zinc-800 sm:p-6">
                <div class="space-y-6">
                    <div x-data="faq()" class="space-y-4">
                        <div class="overflow-hidden rounded-2xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-white/[0.03]" x-data="{ open: true }" @click.away="open = false">
                            <!-- Header -->
                            <div @click="open = !open" class="flex items-center justify-between py-3 pl-6 pr-3 cursor-pointer" :class="open ? 'bg-zinc-50 dark:bg-white/[0.03]' : ''">
                                ...
                                <button :class="open 
                                            ...
                                            : 'text-zinc-500 dark:text-zinc-400'" class="flex h-12 w-full max-w-12 items-center justify-center rounded-full bg-zinc-100 duration-200 ease-linear dark:bg-white/[0.03] transition-transform text-zinc-500 dark:text-zinc-400">
                        ...
                        <div class="overflow-hidden rounded-2xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-white/[0.03]" x-data="{ open: false }" @click.away="open = false">
                            <!-- Header -->
                            <div @click="open = !open" class="flex items-center justify-between py-3 pl-6 pr-3 cursor-pointer" :class="open ? 'bg-zinc-50 dark:bg-white/[0.03]' : ''">
                                <h4 class="text-lg font-medium text-zinc-800 dark:text-white/90">
                                    Do I get free updates?
            ...
            <div class="p-4 border-t border-zinc-100 dark:border-zinc-800 sm:p-6">
                <div class="space-y-6">
                    <div class="grid grid-cols-1 gap-x-8 xl:grid-cols-2">
                        <!-- First Column -->
                        <div class="space-y-3">
                            <div x-data="{ isOpen: true }" @click.away="open = false" class="overflow-hidden rounded-xl">
                            ...
                            <div x-data="{ isOpen: false }" @click.away="open = false" class="overflow-hidden rounded-xl">
                                <div :class="isOpen ? 'bg-brand-50 dark:bg-brand-100' : 'bg-zinc-100 dark:bg-white/[0.03]'" class="transition-colors bg-zinc-100 dark:bg-white/[0.03]">
                                    <div @click="isOpen = !isOpen" class="flex items-center justify-between px-6 py-4 cursor-pointer">
                                        <h4 :class="isOpen ? 'text-zinc-800' : 'text-zinc-800 dark:text-white/90'" class="text-lg font-medium text-zinc-800 dark:text-white/90">
