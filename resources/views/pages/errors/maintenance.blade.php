...
@endphp
 ...
 <img src="/images/error/maintenance.svg" alt="404" class="dark:hidden" />
 <img src="/images/error/maintenance-dark.svg" alt="404" class="hidden dark:block" />

 <p class="mt-10 mb-6 text-base text-zinc-700 dark:text-zinc-400 sm:text-lg">
 Nosso site está em manutenção. Retornaremos em breve. Agradecemos a sua paciência.
 </p>
