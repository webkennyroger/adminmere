...
@endphp
  <div class="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
      ...
      <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
          ...
          <img src="/images/error/success.svg" alt="404" class="dark:hidden" />
          <img src="/images/error/success-dark.svg" alt="404" class="hidden dark:block" />

          <p class="mt-10 mb-6 text-base text-zinc-700 dark:text-zinc-400 sm:text-lg">
                Ótimo! Sua mensagem foi enviada com sucesso. Nossa equipe de suporte entrará em contato com você o mais breve possível.
          </p>
