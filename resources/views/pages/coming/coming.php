            ...
            <form>
                <div class="flex flex-col gap-2 sm:flex-row sm:gap-3">
                    <div class="w-full sm:w-[320px]">
                        <input type="email" name="email" id="email" placeholder="Email address" class="w-full px-4 py-3 text-sm text-zinc-800 bg-transparent border border-zinc-300 rounded-lg h-11 shadow-theme-xs placeholder:text-zinc-400 focus:border-brand-300 focus:shadow-focus-ring focus:outline-hidden dark:border-zinc-700 dark:bg-zinc-900 dark:text-white/90 dark:placeholder:text-zinc-400 dark:focus:border-brand-300">
                    </div>

                    <button type="submit" class="flex items-center justify-center w-full gap-2 px-4 py-3 text-sm font-medium text-white bg-zinc-800 rounded-lg hover:bg-brand-600 dark:bg-brand-500 dark:hover:bg-brand-600 sm:w-auto">
