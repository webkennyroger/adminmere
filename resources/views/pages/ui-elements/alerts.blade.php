            ...
            <div class="space-y-4">
                ...
                <x-ui.alert variant="success" title="Custom Content Alert">
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">
                        This alert uses <strong class="text-zinc-900 dark:text-white">custom slot content</strong>
                        instead of the message prop.
                    </p>
                    <ul class="mt-2 text-sm text-zinc-500 dark:text-zinc-400 list-disc list-inside">
            ...
            <div class="space-y-4">
                ...
                <x-ui.alert variant="success" title="Payment Successful">
                    <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-2">
                        Your payment of <strong class="text-zinc-900 dark:text-white">$99.00</strong> has been processed successfully.
                    </p>
                ...
                <x-ui.alert variant="error" title="Form Validation Failed">
                    <ul class="text-sm text-zinc-500 dark:text-zinc-400 list-disc list-inside space-y-1">
