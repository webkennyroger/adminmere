...
<div
    class="overflow-hidden rounded-2xl border border-zinc-200 bg-white px-5 pb-3 pt-4 dark:border-zinc-800 dark:bg-white/[0.03] sm:px-6"
>
    <div class="flex justify-between gap-2 mb-4 sm:items-center">
        <div>
            <h3 class="text-lg font-semibold text-zinc-800 dark:text-white/90">Featured Campaigns</h3>
        </div>
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
        <table class="min-w-full">
            <!-- table header start -->
            <thead>
                <tr class="border-zinc-100 border-y dark:border-zinc-800">
                    <th class="py-3 font-normal">
                        <div class="flex items-center">
                            <p class="text-zinc-500 text-theme-sm dark:text-zinc-400">Creator</p>
                        </div>
                    </th>
                    <th class="py-3 font-normal">
                        <div class="flex items-center">
                            <p class="text-zinc-500 text-theme-sm dark:text-zinc-400">Campaign</p>
                        </div>
                    </th>
                    <th class="py-3 font-normal">
                        <div class="flex items-center">
                            <p class="text-zinc-500 text-theme-sm dark:text-zinc-400">Status</p>
                        </div>
                    </th>
                </tr>
            </thead>
                    ...
                    <tr>
                        <td class="py-3">
                            <div class="flex items-center gap-[18px]">
                                ...
                                <div>
                                    <p class="text-zinc-700 text-theme-sm dark:text-zinc-400">
                        ...
                        <td class="py-3">
                            <div class="flex items-center">
                                <div class="flex items-center w-full gap-5">
                                    ...
                                    <div class="truncate">
                                        <p class="mb-0.5 truncate text-theme-sm font-medium text-zinc-700 dark:text-zinc-400">
                                            {{ $campaign['title'] }}
                                        </p>
