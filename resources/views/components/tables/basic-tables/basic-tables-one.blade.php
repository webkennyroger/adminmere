                ...
                <thead>
                    <tr class="border-b border-zinc-100 dark:border-zinc-800">
                        <th class="px-5 py-3 text-left sm:px-6">
                            <p class="font-medium text-zinc-500 text-theme-xs dark:text-zinc-400">
                                User
                            </p>
                        </th>
                        <th class="px-5 py-3 text-left sm:px-6">
                        ...
                        <tr class="border-b border-zinc-100 dark:border-zinc-800">
                            <td class="px-5 py-4 sm:px-6" colspan="1">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="block font-medium text-zinc-800 text-theme-sm dark:text-white/90" x-text="order.user.name"></span>
                                        <span class="block text-zinc-500 text-theme-xs dark:text-zinc-400" x-text="order.user.role"></span>
                                    </div>
                                </div>
                            </td>
                            <td class="px-5 py-4 sm:px-6">
                                <p class="text-zinc-500 text-theme-sm dark:text-zinc-400" x-text="order.projectName"></p>
                            </td>
                            <td class="px-5 py-4 sm:px-6">
                                <div class="flex -space-x-2">
                                    <template x-for="(teamImage, index) in order.team.images" :key="index">
                                        <div class="w-6 h-6 overflow-hidden border-2 border-white rounded-full dark:border-zinc-900">
                            ...
                            <td class="px-5 py-4 sm:px-6">
                                <p class="text-zinc-500 text-theme-sm dark:text-zinc-400" x-text="order.budget"></p>
                            </td>
                        </tr>
                    </template>
                </tbody>
