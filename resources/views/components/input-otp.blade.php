...
<div x-data="{
    ...
    <div class="relative w-full text-center">
        <input type="text" maxlength="{{ $digits }}" x-model="value"
            class="w-full text-center tracking-[1em] text-lg font-bold border-stone-200 dark:border-stone-700 rounded-lg focus:ring-green-500 focus:border-green-500 bg-white dark:bg-stone-900"
