...
<body x-data="{ loaded: true }"
 ...
 class="lg:hidden p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-500">
 ...
 <img class="w-9 h-9 " src="{{ asset('assets/images/logo/merelogo.png') }}" alt="Mere" />
 <span
 ...
 <div class="flex items-center gap-3 shrink-0">
 <!-- Sidebar Toggle Desktop (Right Side) -->
 <button @click.stop="$store.sidebar.isExpanded = !$store.sidebar.isExpanded"
 class="hidden lg:flex p-2 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors items-center justify-center">
 ...
 <!-- Search -->
 <div class="hidden lg:flex items-center bg-zinc-100 dark:bg-zinc-800 px-3 py-2 w-52">
 ...
 <span
 class="absolute -top-0.5 -right-0.5 w-4 h-4 text-[9px] font-bold text-white bg-red-500 flex items-center justify-center border-2 border-white dark:border-zinc-900">
 ...
 class="w-10 h-10 object-cover ring-2 ring-green-500/30 hover:ring-green-500 transition-all cursor-pointer"
 alt="{{ auth()->user()->name }}">
 </a>
 </div>
 @endauth
 ...
 class="flex items-center gap-3.5 px-3 py-2.5 transition-all font-semibold text-[15px] whitespace-nowrap overflow-hidden
 {{ request()->get('feed', 'timeline') === 'timeline' && request()->routeIs('home') ? 'bg-green-500 text-white shadow-sm' : ' hover:bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 dark:hover:bg-zinc-800' }}">
 ...
 <li>
 <a href="#"
 class="flex items-center gap-3.5 px-3 py-2.5 transition-all font-semibold text-[15px] whitespace-nowrap overflow-hidden text-slate-500 hover:bg-slate-100 dark:hover:bg-zinc-800 dark:text-zinc-400">
 <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
 stroke-width="1.75">
 <path stroke-linecap="round" stroke-linejoin="round"
 ...
 <li>
 <a href="#"
 class="flex items-center w-full gap-3.5 px-3 py-2.5 transition-all font-semibold text-[15px] whitespace-nowrap overflow-hidden text-slate-500 hover:bg-slate-100 dark:hover:bg-zinc-800 dark:text-zinc-400">
 <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
 stroke-width="1.75">
 <path stroke-linecap="round" stroke-linejoin="round"
 ...
 <a href="{{ route('home') }}"
 class="p-2 text-zinc-400 hover:text-green-600 hover:bg-green-50 dark:hover:bg-green-600/10 transition-all">
 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
