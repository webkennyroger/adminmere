...
<aside id="sidebar"
 class="fixed flex flex-col mt-0 top-0 px-5 left-0 bg-white dark:bg-zinc-900 dark:border-zinc-800 text-zinc-900 h-screen transition-all duration-300 ease-in-out z-99999 border-r border-zinc-200"
 x-data="{
 openSubmenus: {},
 init() {
 ...
 <div>
 <!-- Menu Group Title -->
 <h2 class="mb-4 text-xs uppercase flex leading-[20px] text-zinc-400"
 :class="(!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen) ?
...
<div x-show="$store.sidebar.isMobileOpen" @click="$store.sidebar.setMobileOpen(false)"
 class="fixed z-50 h-screen w-full bg-zinc-900/50"></div>
