<header
    class="sticky top-0 flex w-full bg-white border-zinc-200 z-99999 dark:border-zinc-800 dark:bg-zinc-900 xl:border-b"
    x-data="{
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            class="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-zinc-200 dark:border-zinc-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 lg:py-4">

            <!-- Desktop Sidebar Toggle Button (visible on xl and up) -->
            <button
                class="hidden xl:flex items-center justify-center w-10 h-10 text-zinc-500 border border-zinc-200 rounded-lg dark:border-zinc-800 dark:text-zinc-400 lg:h-11 lg:w-11"
                :class="{ 'bg-zinc-100 dark:bg-white/[0.03]': !$store.sidebar.isExpanded }"
            ...
            <button
                class="flex xl:hidden items-center justify-center w-10 h-10 text-zinc-500 rounded-lg dark:text-zinc-400 lg:h-11 lg:w-11"
                :class="{ 'bg-zinc-100 dark:bg-white/[0.03]': $store.sidebar.isMobileOpen }"
            ...
            <button @click="toggleApplicationMenu()"
                class="flex items-center justify-center w-10 h-10 text-zinc-700 rounded-lg z-99999 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800 xl:hidden">
                <!-- Dots Icon -->
