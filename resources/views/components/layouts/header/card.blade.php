<div {{ $attributes->merge(['class' => "bg-white dark:bg-zinc-900 shadow-md overflow-hidden " . $widthClass . " " . $heightClass]) }}>
 ...
 @if ($showTimeFilter)
 <div class="ml-4">
 <select class="block py-1.5 px-3 border border-zinc-300 dark:border-zinc-600 bg-white dark:bg-zinc-700 text-zinc-700 dark:text-zinc-200 shadow-sm text-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
