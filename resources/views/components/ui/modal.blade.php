...
tabindex="-1">
    ...
    <div class="fixed inset-0 z-[101] overflow-y-auto overflow-x-hidden flex items-start justify-center p-4 pt-8 sm:pt-14 pointer-events-none">
        <div x-show="open" 
            x-transition:enter="ease-out transition-all duration-500" 
            x-transition:enter-start="opacity-0 -mt-7"
            ...
            x-transition:leave-end="opacity-0 -mt-7"
            ...
            @if ($showCloseButton)
                <div class="absolute top-2 end-2 z-10">
                    <button @click="open = false; $wire.dispatch('modal-closed')" type="button" class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 dark:bg-neutral-700 text-gray-800 dark:text-neutral-200 hover:bg-gray-200 dark:hover:bg-neutral-600 focus:outline-hidden" aria-label="Close">
