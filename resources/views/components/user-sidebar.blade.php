<div>
 ...
 <!-- Página Inicial -->
 <a href="{{ route('home') }}"
 class="flex items-center gap-3 px-3 py-3 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
 ...
 class="flex items-center gap-3 px-3 py-3 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors {{ request()->get('feed') === 'personal' ? 'bg-zinc-100 dark:bg-zinc-800' : '' }}"
 :class="!$store.userSidebar.isOpen && 'justify-center'">
 <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
 ...
 class="w-full flex items-center gap-3 px-3 py-3 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
 :class="!$store.userSidebar.isOpen && 'justify-center'">
 <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
 ...
 class="block px-3 py-2 text-sm text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
 Lista de Tickets
 </a>
