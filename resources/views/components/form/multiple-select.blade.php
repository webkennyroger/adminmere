...
<div class="relative w-full">
    ...
    @endif
        ...
        <!-- Trigger -->
        <div @click="open = !open"
            class="shadow-theme-xs flex min-h-[44px] w-full cursor-pointer items-center justify-between gap-2 rounded-lg border border-zinc-300 bg-white px-3 py-2 transition dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <template x-if="multiple && Array.isArray(selected) && selected.length > 0">
                    <div class="flex flex-wrap gap-2">
                        <template x-for="value in selected" :key="value">
                            <div class="group flex items-center justify-center rounded-full border-[0.7px] border-transparent bg-zinc-100 py-0.5 px-2 text-sm text-zinc-800 dark:bg-zinc-800 dark:text-white/90">
        ...
        <div x-show="open"
            ...
            class="absolute z-50 mt-1 w-full overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-lg dark:border-zinc-700 dark:bg-zinc-900"
            style="display: none;">
