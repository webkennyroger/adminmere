...
>
 ...
 class="dark:bg-dark-900 border-error-300 shadow-theme-xs focus:border-error-300 focus:ring-error-500/10 dark:border-error-700 dark:focus:border-error-800 w-full border bg-transparent px-4 py-2.5 pr-10 text-sm text-zinc-800 placeholder:text-zinc-400 focus:ring-3 focus:outline-hidden dark:bg-zinc-900 dark:text-white/90 dark:placeholder:text-white/30" />
 ...
 class="shadow-theme-xs focus:border-brand-300 focus:shadow-focus-ring dark:focus:border-brand-300 h-11 w-full border border-zinc-300 bg-transparent px-4 py-2.5 text-sm text-zinc-800 placeholder:text-zinc-400 focus:outline-hidden disabled:border-zinc-100 disabled:placeholder:text-zinc-300 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white/90 dark:placeholder:text-zinc-400 dark:disabled:border-zinc-800 dark:disabled:placeholder:text-white/15" />
 </div>
 </div>
</x-common.component-card>
