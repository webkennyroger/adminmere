<x-common.component-card title="Radio Buttons">
 ...
 class="flex cursor-pointer items-center text-sm font-medium text-zinc-700 select-none dark:text-zinc-400">
 <div class="relative">
 ...
 class="hover:border-brand-500 dark:hover:border-brand-500 mr-3 flex h-5 w-5 items-center justify-center border-[1.25px]">
 <span class="h-2 w-2 "
 ...
 class="flex cursor-pointer items-center text-sm font-medium text-zinc-300 select-none dark:text-zinc-700">
 <div class="relative">
 <input type="checkbox" id="radioLabelThree" class="peer sr-only"
 @change="checkboxToggle = !checkboxToggle" disabled />
 <div :class="checkboxToggle ? 'bg-transparent border-zinc-300 dark:border-zinc-700' :
 'border-brand-500 bg-brand-500'"
 class="mr-3 flex h-5 w-5 items-center justify-center border-[1.25px]">
 <span class="h-2 w-2 "
 :class="checkboxToggle ? 'bg-white' : 'bg-white dark:bg-[#171f2e]'"></span>
 </div>
 </div>
