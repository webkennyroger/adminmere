...
<div wire:ignore x-data="{
 ...
 class="h-11 w-full border appearance-none px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-zinc-400 focus:outline-hidden focus:ring-3 dark:bg-zinc-900 dark:text-white/90 dark:placeholder:text-white/30 bg-transparent text-zinc-800 border-zinc-300 focus:border-brand-300 focus:ring-brand-500/20 dark:border-zinc-700 dark:focus:border-brand-800"
 autocomplete="off"
 />
 <span class="absolute text-zinc-500 -translate-y-1/2 pointer-events-none right-3 top-1/2 dark:text-zinc-400">
