...
<div x-data="toastManager()" @toast.window="addToast($event.detail)">
 ...
 class="pointer-events-auto w-full overflow-hidden shadow-lg bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5">
 <div class="p-4">
 <div class="flex items-start">
 <div class="shrink-0">
 <div class=" p-2" :class="toast.bgClass">
 <!-- Success Icon -->
