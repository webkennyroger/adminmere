...
<div x-data="toastManager()" @toast.window="addToast($event.detail)">
    <div class="fixed top-20 left-1/2 -translate-x-1/2 z-[999999] space-y-4 pointer-events-none w-full max-w-2xl px-4">
                    ...
                    <div class="flex items-start">
                        <div class="shrink-0">
                            <div class="rounded-lg p-2" :class="toast.bgClass">
                                ...
                                <!-- Warning/Custom Icon -->
                                <svg x-show="toast.type === 'warning' || toast.type === 'custom'" class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
