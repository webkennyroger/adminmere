<div class="flex flex-col rounded-xl bg-blue-50/50 py-5 dark:bg-zinc-800 lg:flex-row">
    <div class="flex min-w-0 flex-col px-4 sm:px-5 lg:w-72 lg:shrink-0 lg:py-3">
        <div class="flex items-center justify-between">
            ...
            <button wire:click="refreshData"
                class="p-1 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-full transition-colors"
        ...
        <div class="mt-3 flex items-center space-x-2">
            <div class="avatar relative inline-flex shrink-0 h-7 w-7">
                <div
                    class="flex h-full w-full items-center justify-center rounded bg-green-100 text-green-700 dark:bg-green-500/10 dark:text-green-400">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
    ...
    <div class="hide-scrollbar flex-1 mt-5 flex space-x-4 overflow-x-auto px-4 sm:px-5 lg:mt-0 lg:pl-0 pb-2">
        @foreach($stats as $stat)
            <div class="relative break-words flex w-36 shrink-0 flex-col items-center group">
                <div
                    class="z-10 flex h-12 w-12 items-center justify-center rounded-full shadow-sm ring-4 ring-white dark:ring-zinc-900 {{ $stat['color_bg'] }} {{ $stat['color_text'] }}">
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="{{ $stat['path'] }}" />
                    </svg>
                </div>
                <div
                    class="relative w-full -mt-6 flex flex-col rounded-2xl bg-white px-3 py-5 text-center shadow-sm dark:bg-zinc-700/50 pt-9 transition-transform hover:-translate-y-1">
