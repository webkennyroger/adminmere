<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 gap-6">
    <!-- Total Users -->
    <div class="flex flex-col gap-6 bg-linear-to-r from-cyan-600/10 to-white dark:to-zinc-700 p-0 border border-zinc-200 dark:border-zinc-700 rounded-md shadow-none">
        <div class="p-4">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-cyan-600 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users-round text-white">
        ...
        <div class="p-4">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-medal text-white">
    ...
    <!-- Revenue (Renda) -->
    <div class="flex flex-col gap-6 bg-linear-to-r from-green-600/10 to-white dark:to-zinc-700 p-0 border border-zinc-200 dark:border-zinc-700 rounded-md shadow-none">
        <div class="p-4">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-zinc-600 dark:text-zinc-300">
                ...
                <div class="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wallet text-white">
        ...
        <div class="p-4">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-text text-white">
