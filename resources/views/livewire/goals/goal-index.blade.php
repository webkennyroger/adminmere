                ...
                <form wire:submit="save" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select wire:model="metric" class="w-full border rounded-lg px-3 py-2 dark:bg-zinc-800 dark:border-zinc-700">
                                <option value="users">Usuários</option>
                                <option value="sales">Vendas</option>
                                <option value="expenses">Despesas</option>
                                <option value="revenue">Renda</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select wire:model="period" class="w-full border rounded-lg px-3 py-2 dark:bg-zinc-800 dark:border-zinc-700">
