<div x-data="{ modalFoto: false, modalVideo: false, modalEvento: false, modalEnquete: false }"
 class="bg-white dark:bg-zinc-900 shadow-sm border border-zinc-200 dark:border-zinc-800 p-4 transition-all hover:shadow-md">

 {{-- Avatar + placeholder clicável --}}
 <div class="flex items-center gap-3 mb-3">
 @if(auth()->user()->image_url)
 <img src="{{ auth()->user()->image_url }}"
 class="w-10 h-10 border border-zinc-100 dark:border-zinc-700 object-cover shrink-0">
 @else
 <div
 class="w-10 h-10 bg-brand-600 flex items-center justify-center text-white font-bold text-sm shrink-0">
 {{ substr(auth()->user()->name, 0, 1) }}
 </div>
 @endif
 <button type="button" @click="modalFoto = true"
 class="flex-1 text-left bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 px-5 py-2.5 text-[15px] text-zinc-500 dark:text-zinc-400 transition-colors cursor-pointer">
 ...
 {{-- FOTO --}}
 <button type="button" @click="modalFoto = true"
 class="flex flex-1 items-center justify-center gap-2 px-2 py-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
 ...
 <div class="relative bg-white dark:bg-zinc-900 shadow-2xl w-full max-w-md mx-4 overflow-hidden">
 ...
 class="text-zinc-400 hover:text-zinc-600 p-1 hover:bg-zinc-100 dark:hover:bg-zinc-800">
 ...
 class="w-full border border-zinc-200 dark:border-zinc-700 px-4 py-2.5 text-sm bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent">
 </div>
 <div>
 ...
 class="w-full border border-zinc-200 dark:border-zinc-700 px-4 py-2.5 text-sm bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent resize-none"></textarea>
 </div>
 {{-- Upload --}}
 <div>
 ...
 <div
 class="border-2 border-dashed border-zinc-200 dark:border-zinc-700 p-10 flex flex-col items-center gap-3 hover:border-green-400 hover:bg-green-50 dark:hover:bg-green-900/10 transition-colors">
 ...
 <div class="aspect-square overflow-hidden border border-zinc-200 dark:border-zinc-700">
 ...
 class="px-5 py-2 text-sm font-semibold text-red-500 bg-red-50 hover:bg-red-100 dark:bg-red-900/20 transition-colors">Cancelar</button>
 <button type="button" wire:click="save" @click="modalFoto = false"
 class="px-5 py-2 text-sm font-semibold text-green-600 bg-green-50 hover:bg-green-100 dark:bg-green-900/20 transition-colors">Publicar</button>
 </div>
 </div>
 </div>
 ...
 <label class="cursor-pointer block">
 <div
 class="border-2 border-dashed border-zinc-200 dark:border-zinc-700 p-10 flex flex-col items-center gap-3 hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-colors">
 <svg class="w-12 h-12 text-zinc-300 dark:text-zinc-600" fill="none" viewBox="0 0 24 24"
 stroke="currentColor">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
 d="M15 10l4.553-2.276A1 1 0 0121 8.723v6.554a1 1 0 01-1.447.894L15 14M4 8a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2V8z" />
 ...
 <div
 class="aspect-video overflow-hidden border border-zinc-200 dark:border-zinc-700 bg-black">
 <video src="{{ $video->temporaryUrl() }}" class="w-full h-full object-cover" controls></video>
 </div>
 @elseif($video)
 <div
 class="aspect-video overflow-hidden border border-zinc-200 dark:border-zinc-700 bg-zinc-100 flex items-center justify-center p-4">
 ...
 <div
 class="relative bg-white dark:bg-zinc-900 shadow-2xl w-full max-w-md mx-4 overflow-hidden max-h-[90vh] overflow-y-auto">
 <div
 ...
 {{-- Opções --}}
 <div
 class="bg-zinc-50 dark:bg-zinc-800/50 p-4 border border-zinc-200 dark:border-zinc-700 space-y-2.5">
 ...
 class="flex-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-sm px-3 py-2 focus:ring-brand-500 focus:border-brand-500 dark:text-white"
 placeholder="Opção {{ $index + 1 }}">
 @if($index > 1)
 <button type="button" wire:click="removePollOption({{ $index }})"
 class="text-red-500 p-1.5 hover:bg-red-50 transition-colors">
 ...
 class="w-4 h-4 text-brand-600 focus:ring-brand-500 border-zinc-300">
 ...
 class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-sm py-1.5 px-3">
 ...
 class="px-5 py-2 text-sm font-semibold text-brand-600 bg-brand-50 hover:bg-brand-100 dark:bg-brand-900/20 transition-colors">Publicar
 enquete</button>
 </div>
 </div>
 </div>
