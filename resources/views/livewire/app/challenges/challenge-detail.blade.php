<div class="bg-white dark:bg-zinc-950 min-h-screen font-sans">
    ...
    <div class="relative w-full h-48 md:h-64 bg-[#FC4C02] overflow-hidden">
        ...
        <div class="absolute inset-0">
            <div
                class="absolute -top-24 -left-24 w-96 h-96 bg-orange-600 rounded-full mix-blend-multiply filter blur-3xl opacity-50">
            </div>
            <div
                class="absolute -bottom-24 -right-24 w-96 h-96 bg-yellow-500 rounded-full mix-blend-multiply filter blur-3xl opacity-50">
            </div>
            <!-- Dynamic lines -->
    ...
    <div class=" mx-auto px-4 sm:px-6 -mt-16 relative z-20 pb-20">
        ...
        <div class="text-center mb-8">
            ...
            <div class="relative inline-block">
                <div
                    class="w-32 h-32 bg-cyan-400 rounded-2xl rotate-45 flex items-center justify-center border-4 border-white dark:border-zinc-900 shadow-xl mx-auto mb-6 transform hover:scale-105 transition-transform duration-300">
                    <div
                        class="w-24 h-24 bg-cyan-500 rounded-xl flex items-center justify-center border-2 border-white/20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="lg:col-span-2 space-y-6" x-data="{ tab: 'overview' }">
                ...
                <div x-show="tab === 'overview'"
                    class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm transition-all duration-300">
                    @if($isJoined)
                        ...
                        <div class="w-full bg-zinc-100 dark:bg-zinc-800 rounded-full h-4 mb-6">
                            <div class="bg-green-500 h-4 rounded-full shadow-[0_0_10px_rgba(34,197,94,0.5)] transition-all duration-1000"
                        ...
                        <div class="mb-6">
                            <div class="bg-zinc-100 dark:bg-zinc-800 rounded-lg p-4 text-center">
                                ...
                                <button wire:click="join"
                                    class="mt-3 bg-[#FC4C02] hover:bg-[#e04302] text-white font-bold py-2 px-6 rounded-md shadow-sm transition-colors uppercase text-sm tracking-wide">
                                    Participar Agora
                                </button>
                            </div>
                        </div>
                                        ...
                                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center gap-3">
                                                    <div class="w-8 h-8 rounded-full bg-zinc-200 dark:bg-zinc-700 overflow-hidden">
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-3">
                    @if(!$isJoined)
                        <button wire:click="join"
                            class="w-full bg-[#FC4C02] hover:bg-[#e04302] text-white font-bold py-3 px-4 rounded-md shadow-sm transition-colors uppercase text-sm tracking-wide">
                            Participar do Desafio
                        </button>
                    @else
                        <button wire:click="confirmLeave"
                            class="w-full bg-white hover:bg-red-50 text-red-600 font-bold py-3 px-4 rounded-md border border-red-200 hover:border-red-300 transition-colors uppercase text-sm tracking-wide">
                            Sair do Desafio
                        </button>
                    @endif
                </div>
                ...
                <div
                    class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm text-center">
        ...
        @if($showLeaveModal)
            <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                ...
                <div
                    class="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-xl ring-1 ring-zinc-900/5 transition-all transform">
                    <div class="text-center">
                        <div
