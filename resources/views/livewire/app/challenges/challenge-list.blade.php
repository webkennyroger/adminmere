<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
 ...
 <div class="relative w-full overflow-hidden shadow-2xl bg-brand-600">
 ...
 <div
 class="absolute bottom-0 right-10 w-64 h-64 bg-yellow-400 mix-blend-overlay filter blur-3xl opacity-20">
 </div>
 <div
 class="absolute top-10 left-10 w-32 h-32 bg-white mix-blend-overlay filter blur-2xl opacity-10">
 </div>
 ...
 <span
 class="bg-white/20 backdrop-blur-md px-3 py-1 text-xs font-bold uppercase tracking-wider">Destaque
 do Mês</span>
 </div>
 ...
 class="bg-white text-brand-600 hover:bg-zinc-50 font-bold py-3 px-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5">
 Sair do Desafio
 </button>
 @else
 ...
 <!-- Badges floating -->
 <div class="absolute top-4 right-4 bg-white p-2 shadow-lg transform rotate-12">
 <div class="w-20 h-20 flex items-center justify-center text-3xl">🥇</div>
 </div>
 <div class="absolute bottom-4 right-20 bg-white p-2 shadow-lg transform -rotate-6">
 <div class="w-16 h-16 flex items-center justify-center text-3xl">👟</div>
 </div>
 <div
 class="absolute top-1/2 left-4 bg-zinc-900 border-2 border-white p-2 shadow-2xl transform -rotate-12 z-20">
 ...
 class="px-6 py-2 border text-sm font-bold whitespace-nowrap transition-colors shadow-sm {{ $selectedCategory === 'all' ? 'border-brand-600 text-brand-600 bg-brand-50 dark:bg-brand-900/10' : 'bg-white dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-200 hover:border-zinc-400 dark:hover:border-zinc-500' }}">
 Todos
 </button>

 <button wire:click="setCategory('my')"
 class="px-6 py-2 border text-sm font-bold whitespace-nowrap transition-colors shadow-sm {{ $selectedCategory === 'my' ? 'border-brand-600 text-brand-600 bg-brand-50 dark:bg-brand-900/10' : 'bg-white dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-200 hover:border-zinc-400 dark:hover:border-zinc-500' }}">
 Meus Desafios
 </button>

 @foreach($categories as $category)
 <button wire:click="setCategory('{{ $category->slug }}')"
 class="px-6 py-2 border text-sm font-bold whitespace-nowrap transition-colors shadow-sm flex items-center gap-2 {{ $selectedCategory === $category->slug ? 'border-brand-600 text-brand-600 bg-brand-50 dark:bg-brand-900/10' : 'bg-white dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-200 hover:border-zinc-400 dark:hover:border-zinc-500' }}">
 @if($category->icon)
 ...
 class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col h-full group relative">
 ...
 <!-- Logo Badge -->
 <div
 class="absolute top-3 left-3 bg-white dark:bg-zinc-900 px-2 py-1 shadow-sm border border-zinc-100 dark:border-zinc-700">
 ...
 <div class="bg-brand-600 h-1.5 transition-all duration-500"
 ...
 class="w-full border border-brand-600/30 text-brand-600 bg-brand-50 dark:bg-brand-900/10 hover:bg-red-50 hover:text-red-600 hover:border-red-200 dark:hover:bg-red-900/20 dark:hover:text-red-400 dark:hover:border-red-800/50 py-2 text-sm font-bold transition-all group relative">
 ...
 class="w-full bg-brand-600 hover:bg-brand-700 text-white py-2 text-sm font-bold shadow-md shadow-brand-900/10 transition-colors">
 Participar do Desafio
 </button>
 @endif
 </div>
 ...
 <div
 class="relative w-full max-w-md bg-white dark:bg-zinc-900 p-6 shadow-xl ring-1 ring-zinc-900/5 transition-all transform scale-100 opacity-100">
