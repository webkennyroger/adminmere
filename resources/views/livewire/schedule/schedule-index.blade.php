<div wire:ignore>
 ...
 <button
 class="btn-create-main px-4 py-2 bg-brand-600 text-white hover:bg-brand-700 font-medium flex items-center gap-2">
 ...
 <div class=" border border-zinc-200 bg-white pt-4 dark:border-zinc-800 dark:bg-zinc-900">
 ...
 style="display: none;">
 <div class="bg-white dark:bg-zinc-900 shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
 <div class="p-6">
 ...
 class="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white"
 ...
 class="w-full h-32 px-3 py-2 border border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white resize-none"
 ...
 <button type="button"
 class="modal-close-btn px-4 py-2 bg-zinc-200 text-zinc-800 hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-200">
 Cancelar
 </button>
 <button type="button"
 class="btn-add-event px-4 py-2 bg-blue-600 text-white hover:bg-blue-700">
 Adicionar Evento
 </button>
 <button type="button"
 class="btn-update-event px-4 py-2 bg-green-600 text-white hover:bg-green-700"
 style="display: none;">
 Atualizar Evento
 </button>
 <button type="button"
 class="btn-delete-event px-4 py-2 bg-red-600 text-white hover:bg-red-700 flex items-center gap-2"
 style="display: none;">
 ...
 <div class="flex justify-end gap-3 mt-6">
 <button type="button"
 class="view-modal-close-btn px-4 py-2 bg-zinc-200 text-zinc-800 hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-200">
 Fechar
 </button>
 <button type="button"
 class="btn-edit-from-view px-4 py-2 bg-blue-600 text-white hover:bg-blue-700 flex items-center gap-2">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
 ...
 <button type="button"
 class="btn-delete-event-view px-4 py-2 bg-red-600 text-white hover:bg-red-700 flex items-center gap-2">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
 d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16">
 </path>
