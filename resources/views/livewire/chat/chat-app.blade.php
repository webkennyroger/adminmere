<div x-data="{ chat: 'aberto' }">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        <div
            class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-md transition-transform shadow-md overflow-hidden !p-0 col-span-12 md:col-span-4 xl:col-span-3">
            ...
            <div class="flex h-full w-full flex-col overflow-hidden rounded-md">
                <div class="border-t border-zinc-200">
                    <div class="flex h-12 items-center gap-2 border-b px-3">
                        ...
                        <input
                            class="placeholder:text-muted-foreground flex h-16 w-full rounded-md bg-transparent py-3 text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50"
                ...
                <div class="scroll-py-1 overflow-x-hidden overflow-y-auto max-h-[580px]">
                    <a class="flex items-center justify-between gap-2 cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-700 px-6 py-2.5 w-full active"
                        ...
                        <div class="flex items-center gap-2">
                            <div class="">
                                <img class="h-10 w-10 rounded-full" alt="image" loading="lazy"
        ...
        <div class=" col-span-12 md:col-span-8 xl:col-span-9">
            <div
                class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-md transition-transform overflow-hidden !p-0 flex flex-col">
                <div
                    class="flex items-center justify-between gap-2  px-6 py-2.5 active border-b border-zinc-200 dark:border-zinc-600">
                    <div class="flex items-center gap-2">
                        <div class="h-10 w-10 rounded-full overflow-hidden flex items-center justify-center">
                            <img alt="image" loading="lazy" src="{{ asset('assets/images/users/avatar-2.jpg') }}">
                        </div>
                    ...
                    <div class="action inline-flex items-center gap-3">
                        <button
                            class=" items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([class*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[.95] cursor-pointer shadow-xs h-9 px-4 py-2 has-[&gt;svg]:px-3 text-xl text-zinc-600 dark:text-zinc-200 flex !p-0 bg-transparent hover:bg-transparent"
                            type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-phone text-zinc-500 dark:text-zinc-100">
                                <path
                        ...
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-video text-zinc-500 dark:text-zinc-100">
                ...
                <div class="chat-message-list max-h-[568px] overflow-y-auto flex flex-col p-6 gap-6">
                    <div class="max-w-[700px] duration-500 text-zinc-900 flex items-end gap-3">
                        <img class="h-10 w-10 object-cover rounded-full" alt="image" loading="lazy"
                            src="{{ asset('assets/images/users/avatar-2.jpg') }}">
                    ...
                    <div class="max-w-[700px] duration-500 text-zinc-900 flex items-end gap-3">
                        <img class="h-10 w-10 object-cover rounded-full" alt="image" loading="lazy"
                            src="{{ asset('assets/images/users/avatar-2.jpg') }}">
                        <div class="bg-zinc-50 dark:bg-zinc-800 dark:text-white rounded-2xl rounded-es-none p-5">
                            <p class="mb-3">Meus estudos estão indo bem. Há alguns dias fiz minha prova final e meu
                                resultado já foi divulgado.</p>
                            <p class="chat-time mb-0 text-xs text-end text-zinc-500 dark:text-zinc-100">
                                <span>6:34 pm</span>
                            </p>
                        </div>
                ...
                <form
                    class="flex items-center justify-between py-4 border-t border-zinc-200 dark:border-zinc-600 mt-auto px-3">
                    <x-form.text-area name="chat-message" height="h-20" placeholder="Escreva uma mensagem..." />
                    <div class="chat-message-box-action flex items-center gap-4">
                        <label
                            class="items-center gap-2 font-medium select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50 text-xl flex !p-0 bg-transparent hover:bg-transparent cursor-pointer"
                            for="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                            ...
                            <input
                                class="file:text-foreground placeholder:text-muted-foreground selection:bg-green-300 selection:text-green-300-foreground dark:bg-input/30 border-input flex h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive"
                        ...
                        <button
                            class="justify-center whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([class*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[.95] cursor-pointer bg-green-300 text-green-300-foreground shadow-xs hover:bg-green-300/90 dark:text-white h-9 px-4 py-2 has-[&gt;svg]:px-3 rounded-lg inline-flex items-center gap-1"
                            type="submit">
                            Enviar
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
