<div class="p-6">
 ...
 class="px-4 py-2 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500">
 </div>
 ...
 <img class="h-10 w-10 object-cover border border-zinc-100 dark:border-zinc-700"
 src="{{ $activity->user->image_url }}" alt="">
 @else
 <div
 class="h-10 w-10 bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 font-bold">
 ...
 <span
 class="px-2 inline-flex text-[10px] leading-4 font-bold uppercase {{ $activity->feed_type === 'community' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' : 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' }}">
 ...
 <div class="w-8 h-8 border-2 border-white dark:border-zinc-900 bg-zinc-200 dark:bg-zinc-800 bg-cover bg-center shadow-sm"
 style="background-image: url('{{ $media }}')"></div>
 @endforeach
 @if(count($activity->media) > 3)
 <div
 class="w-8 h-8 border-2 border-white dark:border-zinc-900 bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-[10px] font-bold text-zinc-500 dark:text-zinc-400">
