<div>
 ...
 @if(session('status'))
 <div class=" bg-green-50 p-4 text-sm text-green-800 dark:bg-green-500/10 dark:text-green-500">
 {{ session('status') }}
 </div>
 @endif
 ...
 class="h-11 w-full border border-zinc-300 bg-transparent px-4 py-2.5 text-sm text-zinc-800 placeholder-zinc-400 focus:border-brand-500 focus:ring-0 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:placeholder-zinc-500 dark:focus:border-brand-500"
 ...
 <div class="pt-2">
 <button type="submit"
 class="flex w-full items-center justify-center bg-brand-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600">
 Enviar Solicitação
 </button>
 </div>
 </form>
 ...
 <div
 class="mb-4 flex h-16 w-16 items-center justify-center bg-zinc-50 dark:bg-zinc-800">
 ...
 class="group block border border-zinc-200 p-4 transition-colors hover:border-brand-500 hover:bg-zinc-50 dark:border-zinc-800 dark:hover:border-brand-500 dark:hover:bg-white/[0.03]">
