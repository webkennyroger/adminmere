        ...
        <div class="flex flex-col gap-4 px-4 py-4">
            ...
            <div class="flex items-center gap-2">
                <button wire:click="setFilter('all')"
                    class="rounded-lg px-4 py-2 text-sm font-medium transition-colors {{ $status === 'all' ? 'bg-brand-500 text-white' : 'bg-zinc-100 text-zinc-600 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700' }}">
                    Todos
                </button>
                <button wire:click="setFilter('solved')"
                    class="rounded-lg px-4 py-2 text-sm font-medium transition-colors {{ $status === 'solved' ? 'bg-brand-500 text-white' : 'bg-zinc-100 text-zinc-600 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700' }}">
                    Resolvidos
                </button>
                <button wire:click="setFilter('pending')"
                    class="rounded-lg px-4 py-2 text-sm font-medium transition-colors {{ $status === 'pending' ? 'bg-brand-500 text-white' : 'bg-zinc-100 text-zinc-600 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700' }}">
                    Pendentes
                </button>
            </div>
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative z-20 bg-transparent">
                        <select wire:model.live="perPage"
                            class="w-full py-2 pl-3 pr-8 text-sm text-zinc-800 bg-transparent border border-zinc-300 rounded-lg appearance-none h-9 shadow-theme-xs focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white/90 dark:focus:border-brand-800">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <a href="{{ route('support.index') }}"
                        class="bg-green-600 hover:bg-green-500 text-white rounded-lg h-11 px-4 py-2.5 text-sm font-medium transition-colors flex items-center justify-center">
                        Novo Ticket
                    </a>
                </div>
            </div>
