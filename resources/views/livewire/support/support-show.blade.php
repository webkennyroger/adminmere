<div>
 ...
 <!-- Ticket Header -->
 <div class=" border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-white/[0.03]">
 ...
 class="flex items-center gap-2 border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-400 dark:hover:bg-white/[0.03]">
 ...
 <div
 class="flex h-10 w-10 items-center justify-center bg-zinc-100 text-sm font-medium text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300">
 ...
 <div
 class=" px-6 py-4 {{ $reply->user_id === auth()->id() ? 'bg-brand-500 text-white' : 'bg-white border border-zinc-200 dark:bg-white/[0.03] dark:border-zinc-800' }}">
 <p
 ...
 <button type="submit"
 class="flex items-center justify-center bg-brand-500 px-6 py-2.5 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600">
 Enviar Resposta
 </button>
 </div>
 </form>
 ...
 <div
 class="sticky top-6 border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-white/[0.03]">
 <h3 class="mb-4 text-lg font-medium text-zinc-800 dark:text-white/90">
 Informações
 </h3>
 <div>
 ...
 <button type="submit"
 class="w-full bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-brand-600">
 Salvar Status
 </button>
 </form>
 @else
 ...
 <span class="text-theme-xs px-2 py-0.5 font-medium
