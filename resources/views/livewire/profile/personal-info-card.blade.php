<div class="p-5 mb-6 border border-zinc-200 dark:border-zinc-800 lg:p-6">
 ...
 @if ($image)
 <img src="{{ $image->temporaryUrl() }}" class="w-16 h-16 object-cover">
 @elseif ($user->profile?->image)
 <img src="{{ Storage::url($user->profile->image) }}"
 class="w-16 h-16 object-cover">
 @else
 <div
 class="w-16 h-16 bg-zinc-200 dark:bg-zinc-700 flex items-center justify-center text-zinc-400">
 ...
 class="dark:bg-dark-900 h-11 w-full border border-zinc-300 bg-transparent bg-none pl-8 pr-4 py-2.5 text-sm text-zinc-800 shadow-theme-xs placeholder:text-zinc-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
 </div>
