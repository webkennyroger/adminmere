<div>
 ...
 <div class="mb-6 border border-zinc-200 p-5 lg:p-6 dark:border-zinc-800">
 <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
 <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
 <div class="h-20 w-20 overflow-hidden bg-zinc-100">
 @if ($image)
 ...
 target="_blank"
 class="flex h-10 w-10 items-center justify-center border border-zinc-200 text-zinc-500 transition-colors hover:bg-zinc-50 hover:text-zinc-800 dark:border-zinc-700 dark:text-zinc-400 dark:hover:bg-white/5 dark:hover:text-zinc-200">
 ...
 class="flex items-center gap-2 border border-zinc-300 bg-white px-5 py-2.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-white/5">
