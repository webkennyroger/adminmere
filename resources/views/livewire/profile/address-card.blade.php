<div>
 <div class="p-5 border border-zinc-200 dark:border-zinc-800 lg:p-6">
 ...
 class="flex w-full items-center justify-center gap-2 border border-zinc-300 bg-white px-4 py-3 text-sm font-medium text-zinc-700 shadow-theme-xs hover:bg-zinc-50 hover:text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:bg-white/[0.03] dark:hover:text-zinc-200 lg:inline-flex lg:w-auto">
