...
<div>
    <div class="min-h-screen bg-zinc-50 dark:bg-zinc-900">
        ...
        <div class="relative w-full h-[200px] md:h-[350px]">
            ...
            <a href="{{ route('profile.edit') }}" wire:navigate class="absolute top-4 right-4 md:top-6 md:right-6 bg-white p-2 md:p-2.5 rounded-full shadow-md text-gray-500 hover:text-blue-500 transition">
        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 relative mt-[-50px] md:mt-[-80px]">
            <div class="bg-white rounded-xl shadow-sm px-4 md:px-6 pb-6 md:pb-8 pt-16 md:pt-6 relative flex flex-col items-center md:block">
                <div class="absolute -top-[50px] md:-top-[60px] left-1/2 transform -translate-x-1/2 flex flex-col items-center">
                    <div class="relative">
                        <img src="{{ $user->image_url }}" alt="Profile" class="w-[100px] h-[100px] md:w-[120px] md:h-[120px] rounded-2xl border-4 border-white object-cover shadow-lg">
                        <button class="absolute -top-1 -right-1 md:-top-2 md:-right-2 bg-green-500 text-white p-1 md:p-1.5 rounded-full border-2 border-white shadow-sm">
                    ...
                    @if($user->subscribed() || in_array($user->profile?->plan, ['pro', 'premium']))
                        <span class="bg-emerald-400 text-white text-[10px] md:text-[11px] font-bold px-3 py-0.5 rounded-full uppercase tracking-wider -mt-3 relative z-10 border-2 border-white">
                            Assinante
                        </span>
                    @else
                        <span class="bg-emerald-400 text-white text-[10px] md:text-[11px] font-bold px-3 py-0.5 rounded-full uppercase tracking-wider -mt-3 relative z-10 border-2 border-white">
            ...
            <div class="bg-white dark:bg-zinc-900 border-r border-zinc-200/80 dark:border-zinc-800 mt-4 md:mt-6 rounded-xl shadow-sm px-2 md:px-4 py-2 relative">
                <div class="flex overflow-x-auto hide-scrollbar snap-x items-center justify-start md:justify-between px-2 md:px-8">
                    <button wire:click="setTab('timeline')" class="snap-start flex-shrink-0 flex flex-col items-center p-3 md:p-4 min-w-[90px] transition-colors {{ $activeTab === 'timeline' ? 'text-green-500' : 'text-gray-500 hover:text-green-500' }}">
                        <div class="p-2 md:p-2.5 rounded-xl mb-2 {{ $activeTab === 'timeline' ? 'bg-green-500 text-white' : 'bg-green-50 text-gray-400' }}">
                    ...
                    <button wire:click="setTab('about')" class="snap-start flex-shrink-0 flex flex-col items-center p-3 md:p-4 min-w-[90px] transition-colors {{ $activeTab === 'about' ? 'text-green-500' : 'text-gray-500 hover:text-green-500' }}">
                        <div class="p-2 md:p-2.5 rounded-xl mb-2 {{ $activeTab === 'about' ? 'bg-green-500 text-white' : 'bg-gray-50 text-gray-400' }}">
                    ...
                    <button wire:click="setTab('friends')" class="snap-start flex-shrink-0 flex flex-col items-center p-3 md:p-4 min-w-[90px] transition-colors {{ $activeTab === 'friends' ? 'text-green-500' : 'text-gray-500 hover:text-green-500' }}">
                        <div class="p-2 md:p-2.5 rounded-xl mb-2 {{ $activeTab === 'friends' ? 'bg-green-500 text-white' : 'bg-gray-50 text-gray-400' }}">
                    ...
                    <button wire:click="setTab('groups')" class="snap-start flex-shrink-0 flex flex-col items-center p-3 md:p-4 min-w-[90px] transition-colors {{ $activeTab === 'groups' ? 'text-green-500' : 'text-gray-500 hover:text-green-500' }}">
                        <div class="p-2 md:p-2.5 rounded-xl mb-2 {{ $activeTab === 'groups' ? 'bg-green-500 text-white' : 'bg-gray-50 text-gray-400' }}">
            ...
            <div class="mt-4 md:mt-6">
                @if($activeTab === 'timeline')
                    <div class="bg-transparent rounded-xl h-40 flex items-center justify-center text-gray-400 border-2 border-dashed border-gray-200">
    ...
    <div class="min-h-screen pb-10 bg-zinc-50 dark:bg-zinc-900">
        ...
        <div class="relative w-full h-[200px] md:h-[350px]">
            ...
            <button class="absolute top-4 right-4 md:top-6 md:right-6 bg-white p-2 md:p-2.5 rounded-full shadow-md text-gray-500 hover:text-green-500 transition">
                <svg class="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
            </button>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 relative mt-[-50px] md:mt-[-80px]">
            ...
            <div class="bg-white rounded-xl shadow-sm px-4 md:px-6 pb-6 md:pb-8 pt-16 md:pt-6 relative flex flex-col items-center md:block">
                ...
                <div class="absolute -top-[50px] md:-top-[60px] left-1/2 transform -translate-x-1/2 flex flex-col items-center">
                    <div class="relative">
                        <img src="https://socialv-wordpress.iqonic.design/wp-content/uploads/2022/10/01.jpg" alt="Profile" class="w-[100px] h-[100px] md:w-[120px] md:h-[120px] rounded-2xl border-4 border-white object-cover shadow-lg">
                        <button class="absolute -top-1 -right-1 md:-top-2 md:-right-2 bg-green-500 text-white p-1 md:p-1.5 rounded-full border-2 border-white shadow-sm">
                            <svg class="w-3 h-3 md:w-4 md:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        </button>
                    </div>
                    <span class="bg-emerald-400 text-white text-[10px] md:text-[11px] font-bold px-3 py-0.5 rounded-full uppercase tracking-wider -mt-3 relative z-10 border-2 border-white">Online</span>
                </div>
                ...
                <div class="w-full flex flex-col md:flex-row md:justify-between items-center mt-2 md:mt-0 gap-6 md:gap-0">
                    ...
                    <div class="order-3 md:order-1 w-full md:w-1/3 flex flex-col items-center md:items-start gap-4 md:mt-10">
                        <div class="flex flex-wrap justify-center md:justify-start items-center gap-3 text-sm font-semibold text-gray-800">
                            <div class="flex items-center gap-1.5"><span class="w-3.5 h-3.5 rounded-full bg-yellow-400"></span> 9760 Coins</div>
                            <div class="flex items-center gap-1.5"><span class="w-3.5 h-3.5 rounded-full bg-emerald-500"></span> 15770 Credits</div>
                            <div class="flex items-center gap-1.5"><span class="w-3.5 h-3.5 rounded-sm rotate-45 bg-green-500"></span> <span class="ml-1">100 Gems</span></div>
                        </div>
                        <div class="flex justify-center md:justify-start gap-2">
                            <a href="#" class="w-8 h-8 rounded-full bg-green-600 text-white flex items-center justify-center hover:opacity-80"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a>
                            <a href="#" class="w-8 h-8 rounded-full bg-sky-400 text-white flex items-center justify-center hover:opacity-80"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg></a>
            ...
            <div class="bg-white mt-4 md:mt-6 rounded-xl shadow-sm px-2 md:px-4 py-2 relative">
                ...
                <div class="flex overflow-x-auto hide-scrollbar snap-x items-center justify-start md:justify-between px-2 md:px-8">
                    <button wire:click="setTab('timeline')" class="snap-start flex-shrink-0 flex flex-col items-center p-3 md:p-4 min-w-[90px] transition-colors {{ $activeTab === 'timeline' ? 'text-green-500' : 'text-gray-500 hover:text-green-500' }}">
                        <div class="p-2 md:p-2.5 rounded-xl mb-2 {{ $activeTab === 'timeline' ? 'bg-green-500 text-white' : 'bg-gray-50 text-gray-400' }}">
                            <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        </div>
                    ...
                    <button wire:click="setTab('notifications')" class="snap-start flex-shrink-0 flex flex-col items-center p-3 md:p-4 min-w-[90px] transition-colors {{ $activeTab === 'notifications' ? 'text-green-500' : 'text-gray-500 hover:text-green-500' }}">
                        <div class="p-2 md:p-2.5 rounded-xl mb-2 {{ $activeTab === 'notifications' ? 'bg-green-500 text-white' : 'bg-gray-50 text-gray-400' }}">
            ...
            @if($activeTab === 'timeline')
            <div class="bg-white mt-4 md:mt-6 rounded-xl shadow-sm px-4 md:px-6 py-4 flex flex-col lg:flex-row justify-between lg:items-center gap-4">
                ...
                <div class="flex items-center justify-between lg:justify-end gap-2 w-full lg:w-auto mt-2 lg:mt-0 px-2 lg:px-0">
                    ...
                    <select wire:model.live="filterShow" class="bg-transparent border border-gray-200 text-gray-700 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full lg:w-auto px-3 py-1.5 outline-none cursor-pointer">
