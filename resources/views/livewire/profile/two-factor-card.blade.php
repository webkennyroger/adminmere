...
<div class="w-full">
 @if ($twoFactorEnabled)
 <div class="space-y-4">
 <div class="p-4 bg-green-50 border border-green-200 dark:bg-green-900/20 dark:border-green-800">
 ...
 <button
 wire:click="disable"
 class="flex w-full justify-center bg-red-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-red-600 sm:w-auto"
 >
 Desativar 2FA
 </button>
 </div>
 @else
 <div class="space-y-4">
 <div class="p-4 bg-zinc-50 border border-zinc-200 dark:bg-zinc-800/50 dark:border-zinc-700">
 ...
 <div class="relative w-full max-w-md p-6 bg-white dark:bg-zinc-900">
 ...
 maxlength="6"
 placeholder="000000"
 class="w-full px-4 py-3 text-center text-2xl tracking-widest border border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white"
 />
 @error('code')
 ...
 class="flex-1 px-4 py-2.5 text-sm font-medium border border-zinc-300 hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800"
 >
 Voltar
 </button>
 <button
 wire:click="confirmTwoFactor"
 class="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-brand-500 hover:bg-brand-600"
 >
 Confirmar
 </button>
 </div>
 ...
 @else
 @error('setupData')
 <div class="p-3 text-sm text-red-700 bg-red-100 dark:bg-red-900/20 dark:text-red-400">
 {{ $message }}
 </div>
 @enderror

 <div class="flex justify-center">
 <div class="p-4 bg-white border border-zinc-200">
 @if($qrCodeSvg)
 {!! $qrCodeSvg !!}
 @else
 ...
 <div class="flex items-center gap-2 p-3 bg-zinc-50 border border-zinc-200 dark:bg-zinc-800 dark:border-zinc-700">
 <input
 type="text"
 readonly
 ...
 class="p-2 hover:bg-zinc-200 dark:hover:bg-zinc-700"
 >
 ...
 class="w-full px-4 py-2.5 text-sm font-medium text-white bg-brand-500 hover:bg-brand-600"
 >
 Continuar
 </button>
 @endif
