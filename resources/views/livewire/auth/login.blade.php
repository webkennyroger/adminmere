<x-layouts.auth>
    <div class="flex flex-col gap-6">
        ...
        <a href="{{ route('auth.google') }}"
            class="flex items-center justify-center w-full px-6 py-3.5 text-sm font-semibold text-zinc-900 dark:text-white bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded-2xl shadow-sm hover:bg-zinc-50 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 transition-all duration-200">
