<div class="space-y-6">
 ...
 <!-- Premium Promo Card -->
 <div
 class="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 overflow-hidden shadow-sm relative">
 <div class="p-5 relative z-10">
 <div class="flex justify-between items-start mb-4">
 <h3 class="text-lg font-bold text-zinc-900 dark:text-white leading-tight">
 Experimente o Premium grátis
 </h3>
 <span class="bg-amber-100 text-amber-700 text-xs px-2 py-1 font-bold">Pro</span>
 </div>
 <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-4">
 Desbloqueie estatísticas avançadas e planos de treino personalizados.
 </p>
 <a href="{{ route('billing.index') }}"
 class="block w-full py-2 px-4 bg-linear-to-r from-brand-500 to-brand-600 hover:from-brand-600 hover:to-brand-700 text-white text-center text-sm font-medium shadow-sm transition-all">
 Testar 1 mês grátis
 </a>
 </div>
 </div>
 ...
 <!-- Challenges Section -->
 <div
 class="bg-white dark:bg-zinc-950 p-6 border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col gap-6">
 <section>
 ...
 class="flex gap-4 items-start group cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-800/50 p-2 transition-colors -mx-2"
 ...
 class="w-12 h-12 shadow-lg border border-zinc-200 dark:border-zinc-700 object-cover">
 <span
 class="absolute -bottom-1 -right-1 bg-[#FC4C02] text-[9px] text-white px-1.5 py-0.5 font-bold">{{ $challenge->goal_value ?? 'Go' }}</span>
 </div>
 ...
 class="block w-full text-center mt-6 py-2.5 border border-zinc-200 dark:border-zinc-700 text-xs font-bold text-zinc-600 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-white transition">
 ...
 <div
 class="w-12 h-12 border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center shrink-0">
