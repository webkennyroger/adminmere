<div x-data="{ showComments: @entangle('showComments') }" x-show="showComments" x-transition
 ...
 class="w-8 h-8 border border-zinc-100 dark:border-zinc-800 shrink-0">
 </a>
 <div class="flex-1 min-w-0">
 <div class="bg-zinc-100 dark:bg-zinc-800 px-3 py-2 inline-block">
 <a href="{{ profile_url($comment->user) }}"
 ...
 class="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 p-2 text-sm focus:ring-brand-500 focus:border-brand-500"
 rows="2"></textarea>
 ...
 class="text-xs bg-brand-500 text-white px-3 py-1 font-medium hover:bg-brand-600 transition">Salvar</button>
 </div>
 </div>
 @else
 ...
 class=" max-h-48 object-cover border border-zinc-200 dark:border-zinc-700 hover:opacity-90 transition-opacity"
 ...
 <img src="{{ $reply->user->image_url }}" class="w-6 h-6 ">
 <div class="flex-1">
 <div class="bg-zinc-100 dark:bg-zinc-800 px-3 py-1.5 inline-block">
 ...
 <textarea wire:model="editCommentBody"
 class="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 p-2 text-xs focus:ring-brand-500 focus:border-brand-500"
 rows="2"></textarea>
 ...
 <button wire:click="updateComment"
 class="text-[10px] bg-brand-500 text-white px-2 py-1 font-medium hover:bg-brand-600 transition">Salvar</button>
 </div>
 </div>
 @else
 ...
 class=" max-h-32 object-cover border border-zinc-200 dark:border-zinc-700 hover:opacity-90 transition-opacity"
 ...
 <div
 class="flex items-center gap-2 px-2 py-1.5 mb-1 bg-brand-50 dark:bg-zinc-800 border border-brand-200 dark:border-zinc-700 text-xs text-zinc-600 dark:text-zinc-300">
 ...
 <img src="{{ auth()->user()->image_url }}" class="w-8 h-8 object-cover shrink-0 mt-1">
 <div class="flex-1 relative bg-zinc-100 dark:bg-zinc-800 p-1 px-2 border border-transparent focus-within:border-brand-500 focus-within:ring-1 focus-within:ring-brand-500"
 x-data="{ showMentions: @entangle('showMentions') }">

 @if($commentImage)
 <div class="relative inline-block mt-2 mb-1 mx-2">
 <img src="{{ $commentImage->temporaryUrl() }}"
 class="h-20 border border-zinc-200 dark:border-zinc-700 object-cover">
 <button wire:click="$set('commentImage', null)"
 class="absolute -top-2 -right-2 bg-red-500 text-white p-0.5 shadow hover:bg-red-600 transition">
 ...
 class="cursor-pointer text-zinc-500 hover:text-brand-500 transition-colors p-1.5 hover:bg-zinc-200 dark:hover:bg-zinc-700 flex items-center justify-center"
 ...
 class="text-zinc-500 hover:text-brand-500 transition-colors p-1.5 hover:bg-zinc-200 dark:hover:bg-zinc-700 flex items-center justify-center"
 ...
 class="absolute bottom-full left-0 mb-2 w-64 bg-white dark:bg-zinc-800 shadow-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden z-20">
 ...
 <img src="{{ $user['image_url'] }}" class="w-8 h-8 ">
