    ...
    <div class="px-5 pb-5 text-center relative">
        ...
        <div class="relative -mt-10 mb-3 inline-block">
            <img src="{{ $user->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&color=7F9CF5&background=EBF4FF' }}"
                alt="{{ $user->name }}"
                class="w-20 h-20 rounded-full border-4 border-white dark:border-zinc-900 shadow-md object-cover">
        ...
        <div class="flex justify-between items-center text-center py-2">
            <div class="flex-1 border-r border-zinc-200 dark:border-zinc-800">
                <span class="text-xs text-zinc-500 dark:text-zinc-400 block pb-1">Seguindo</span>
                <span class="block text-xl font-bold text-zinc-900 dark:text-white">2</span>
            </div>
            <div class="flex-1 border-r border-zinc-200 dark:border-zinc-800">
                <span class="text-xs text-zinc-500 dark:text-zinc-400 block pb-1">Seguidores</span>
                <span class="block text-xl font-bold text-zinc-900 dark:text-white">2</span>
            </div>
            <div class="flex-1">
            ...
            <div class="flex items-end gap-3">
                ...
                <div class="flex-1 flex justify-between text-center pb-1 gap-1">
                    ...
                    <div class="flex flex-col items-center gap-1">
                        ...
                        <div class="w-7 h-7 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-xs text-zinc-500">
                            16
                        </div>
                    </div>
                    <div class="flex flex-col items-center gap-1">
