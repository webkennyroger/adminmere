<div
 class="bg-white dark:bg-zinc-900 shadow-sm overflow-hidden border border-zinc-200/80 dark:border-zinc-800 mb-5">
 <!-- Cover Banner -->
 ...
 class="w-20 h-20 object-cover border-4 border-white dark:border-zinc-900 shadow-lg"
 alt="{{ $user->name }}">
 @if($user->isManager() || $user->isAdmin())
 <div
 class="absolute bottom-1 right-1 bg-green-500 text-white p-0.5 border-2 border-white dark:border-zinc-900 shadow-sm">
 ...
 class="flex items-center justify-center gap-2 w-full py-2.5 bg-green-600 hover:bg-green-700 text-white text-sm font-bold transition-all shadow-sm">
