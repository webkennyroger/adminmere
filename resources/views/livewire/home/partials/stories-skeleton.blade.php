<div class="w-full mb-8">
    <div class="flex gap-4 overflow-x-hidden pb-6">
        @foreach(range(1, 10) as $i)
            <div
                class="flex-none w-[130px] sm:w-[150px] h-[200px] sm:h-[240px] rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 flex flex-col justify-between animate-pulse">
                <!-- Circle top left -->
