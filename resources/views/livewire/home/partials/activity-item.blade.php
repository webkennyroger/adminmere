<div x-data="{ 
    ...
    <x-ui.modal wire:model="confirmingCommentDeletion" :maxWidth="'sm:max-w-2xl'" :showCloseButton="false"
        ...
        <div>
            ...
            <div class="p-6 pb-2">
                <div class="flex items-center gap-3 mb-4">
                    <div
                        class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-red-100 dark:bg-red-500/10">
                    ...
                    <h3 class="text-[17px] font-bold text-[#111827] dark:text-white font-['Inter']">Apagar Comentário
                    </h3>
                </div>
    ...
    <x-ui.modal wire:model="editingActivity" :showCloseButton="true" wire:key="edit-activity-modal-{{ $activity->id }}"
        ...
        <div class="p-6">
            <h3 class="text-[20px] font-bold text-[#111827] dark:text-white mb-6 font-['Inter']">Editar Atividade</h3>

            <div class="space-y-4">
                <!-- Title Input -->
                <div class="border border-[#E5E7EB] dark:border-neutral-700 rounded-xl p-3 px-4">
                    <label
                        class="block text-[11px] font-bold text-[#6B7280] dark:text-neutral-400 uppercase tracking-widest mb-1 font-['Inter']">Título</label>
                ...
                <div class="border border-[#E5E7EB] dark:border-neutral-700 rounded-xl p-3 px-4">
                    <label
                        class="block text-[11px] font-bold text-[#6B7280] dark:text-neutral-400 uppercase tracking-widest mb-1 font-['Inter']">Descrição</label>
                    <textarea wire:model="editContent" rows="4"
                        class="w-full bg-transparent border-none p-0 text-[15px] text-[#111827] dark:text-white focus:ring-0 placeholder-gray-400 resize-none font-['Inter']"
    ...
    <x-ui.modal wire:model="confirmingActivityDeletion" :maxWidth="'sm:max-w-2xl'" :showCloseButton="false"
        ...
        <div>
            ...
            <div class="p-6 pb-2">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-[17px] font-bold text-[#111827] dark:text-white font-['Inter']">Apagar Atividade
                    </h3>
                </div>

                <p class="text-[13px] text-[#6B7280] dark:text-neutral-400 leading-relaxed font-['Inter'] mb-6">
                    Tem certeza que deseja remover esta atividade? Esta ação não pode ser desfeita e todos os
                    comentários e curtidas serão perdidos.
                </p>
            </div>
