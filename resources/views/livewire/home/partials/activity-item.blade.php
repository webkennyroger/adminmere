<div x-data="{ showMenu: false }"
 ...
 class="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors group">
 ...
 <!-- Title Input -->
 <div
 class="border border-gray-200 dark:border-neutral-700 p-3 px-4 focus-within:border-blue-500 transition-colors">
 <label
 ...
 <div
 class="relative aspect-square overflow-hidden border border-zinc-200 dark:border-zinc-700 bg-zinc-100 group">
 @if(str_contains($media, '.mp4'))
 ...
 <div
 class="border-2 border-dashed border-zinc-200 dark:border-zinc-700 p-4 flex flex-col items-center gap-1 hover:border-brand-500 transition-colors">
 ...
 <div
 class="aspect-square overflow-hidden border border-zinc-200 dark:border-zinc-700">
 <img src="{{ $photo->temporaryUrl() }}" class="w-full h-full object-cover">
 </div>
 @endforeach
 @foreach($editVideos as $video)
 <div
 class="aspect-square overflow-hidden border border-zinc-200 dark:border-zinc-700 bg-black flex items-center justify-center">
 ...
 <div
 class="mx-auto flex h-14 w-14 flex-shrink-0 items-center justify-center bg-red-100 dark:bg-red-500/20 mb-4">
 ...
 class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold border border-transparent bg-red-500 text-white hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none">
 Apagar
 </button>
 </div>
 </x-ui.modal>
