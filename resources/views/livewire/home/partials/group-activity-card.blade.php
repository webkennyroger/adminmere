...
<div class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden shadow-sm">
    ...
    <!-- Full Width Map -->
    <div class="w-full h-48 bg-zinc-100 dark:bg-zinc-800 relative overflow-hidden"
        x-data="activityMap({type: 'points', data: [{lat: -15.601, lng: -56.097}]})" x-intersect.once="initMap()">
        <div x-ref="mapContainer" class="w-full h-full z-10 opacity-80"></div>
    </div>
