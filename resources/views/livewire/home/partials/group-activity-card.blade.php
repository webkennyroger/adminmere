...
<div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 overflow-hidden shadow-sm">
 <!-- Header: Group Info -->
 <div class="p-4 flex items-center gap-3">
 <div
 class="w-10 h-10 bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center border border-zinc-200 dark:border-zinc-700">
 ...
 class="w-10 h-10 border border-zinc-200 dark:border-zinc-700">
 ...
 <div class="h-32 overflow-hidden bg-zinc-100 relative">
 ...
 <img class="w-6 h-6 border-2 border-white dark:border-zinc-900"
 ...
 <button class="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-orange-500">
 ...
 class="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-500">
 ...
 <img src="{{ auth()->user()->image_url }}" class="w-8 h-8 object-cover">
 <div class="flex-1 bg-zinc-100 dark:bg-zinc-800 flex items-center pr-2">
 ...
 <div class="flex gap-2">
 <button class="p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-500 transition-colors">
 <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
 d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5" />
 </svg>
