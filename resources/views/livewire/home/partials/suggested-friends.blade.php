<div wire:poll.10s>
 <div class="bg-white dark:bg-zinc-950 p-6 border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col gap-6">
 <section>
 ...
 class="absolute top-0 right-0 p-1 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-zinc-900 shadow-sm border border-zinc-100 dark:border-zinc-800"
 title="Dispensar">
 ...
 class="w-12 h-12 border border-zinc-200 dark:border-zinc-800 object-cover hover:ring-2 hover:ring-brand-500 transition-all">
 </a>
 </div>
 ...
 class="mt-2.5 px-6 py-1.5 border border-brand-500 text-brand-600 dark:text-brand-400 text-xs font-bold hover:bg-brand-50 dark:hover:bg-brand-900/20 transition">
 ...
 class="block w-full text-center mt-8 py-2.5 border border-zinc-200 dark:border-zinc-700 text-xs font-bold text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition">
