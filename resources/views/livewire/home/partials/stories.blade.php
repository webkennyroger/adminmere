    ...
    <div x-ref="storyList" @scroll.debounce.100ms="checkScroll()"
        ...
        <div class="flex flex-col items-center flex-shrink-0 min-w-0">
            ...
            <div class="w-28 h-36 flex-none rounded-xl relative shadow-sm cursor-pointer group"
                ...
                <div
                    class="w-full h-full overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 ring-2 {{ $myStoryData ? 'ring-green-500' : 'ring-transparent' }} group-hover:ring-green-400 transition-all">
        ...
        @foreach($stories as $story)
            ...
            <div class="flex flex-col items-center flex-shrink-0 min-w-0">
                <div class="w-28 h-36 flex-none rounded-xl relative shadow-sm cursor-pointer group"
                    ...
                    <div
                        class="w-full h-full overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 ring-2 ring-green-500 group-hover:ring-green-400 transition-all">
