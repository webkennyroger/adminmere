    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div
                    class="bg-white dark:bg-zinc-800 shadow-lg rounded-sm border border-zinc-200 dark:border-zinc-700 p-5">
                    <h2 class="text-lg font-semibold text-zinc-800 dark:text-zinc-100 mb-4">Status da Assinatura</h2>

                    @if(session('success'))
                        <div class="mb-4 p-3 bg-green-100 text-green-700 rounded-sm text-sm">
                            {{ session('success') }}
                        </div>
                    @endif
            ...
            <div class="space-y-6">
                ...
                @foreach($plans as $plan)
                    <div
                        class="bg-white dark:bg-zinc-800 shadow-lg rounded-sm border border-zinc-200 dark:border-zinc-700 p-5 flex flex-col h-full relative overflow-hidden">
